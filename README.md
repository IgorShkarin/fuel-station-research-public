...
![Карта АИ-95: подтверждения наличия и вероятные окна подвоза](assets/ai95-map-clarified.png)

На карточке каждой АЗС видны вероятные окна появления топлива и последнее подтверждение: например, «АИ-95 есть с 22:32 · 1 источник». Кнопка в правом верхнем углу ведёт к полной хронологии статусов и уведомлений.
